...
if not secret_key:
    ...
    print("Warning: No SECRET_KEY environment variable set. Generated temporary key for this session.")
...
cors_origins = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:5001,http://127.0.0.1:5001').split(',')
