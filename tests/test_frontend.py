...
class TestFrontendIntegration:
    ...
    def test_service_worker_cache_names_advance_together(self, client) -> None:
        ...
        assert "const CACHE_NAME = 'weather-dashboard-v8';" in source
        assert "const STATIC_CACHE_NAME = 'weather-dashboard-static-v8';" in source
        assert 'weather-dashboard-v7' not in source
        assert 'weather-dashboard-static-v7' not in source
